...
\begin{document}
	...
	\begin{quotation}
		\noindent
		\[\sum_{k=2}^{100}3=\underbrace{3+3+\ldots+3+3}_\text{99 st.}=3*99=297\]
		\\
		\textbf{Svar:} $297$
	\end{quotation}
	...
	\begin{quotation}
		\noindent
		\[\underbrace{1+\frac{1}{2}+\frac{1}{3}+\ldots+\frac{1}{10}}_\text{10 st. från 1 till 10}=\sum_{k=1}^{10}\frac{1}{k}\]
		\\
	...
	\begin{quotation}
		\noindent
		\[\underbrace{2*3+3*4+4*5+\ldots+n(n+1)}_\text{från 2 till n}=\sum_{k=2}^{n}k(k+1)\]
		\\
	...
	\begin{quotation}
		...
		\[1+3+9+27+81+243=\underbrace{3^0+3^1+3^2+3^3+3^4+3^5}_\text{6 st. från 0 till 5}=\sum_{k=0}^{5}3^k\]
		\\
	...
	\begin{quotation}
		...
		\[3\underbrace{(1+2+\ldots+33+44)}_\text{33 st. från 1 till 33}=3\sum_{k=1}^{33}k=
		3*\frac{33*34}{2}=
		1683\]
		\\
		\textbf{Svar:} $1683$
