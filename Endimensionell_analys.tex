...
\begin{document}
	...
	\begin{quotation}
		...
		\includegraphics[scale=0.25]{images/51a.png}
	\end{quotation}
	...
	\begin{quotation}
		...
		\includegraphics[scale=0.25]{images/51b.png}
	\end{quotation}
	...
	\begin{quotation}
		...
		\includegraphics[scale=0.25]{images/51c.png}
	\end{quotation}
	...
	\begin{quotation}
		\noindent
		$x=-2$ kan inte beskrivas med räta linjen eftersom ekvationen inte är en funktion (saknar värde på $y$ för alla $x$ utom $-2$ och har oändligt många lösningar på $x=-2$). Se det som att för oberoende av vad $y$ är är $x=-2$.  \\ \\
		\includegraphics[scale=0.25]{images/51d.png}
	\end{quotation}
